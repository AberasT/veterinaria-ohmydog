...
class PerroPerdidoForm(ModelForm):
    class Meta:
        model = PerroPerdido
        fields = ["nombre", "color", "raza", "sexo", "edad",
                  "peso", "contacto", "altura",
                   "descripcion", "imagen"]
        ...
        def clean_nombre(self):
            ...
            publicaciones_no_adoptados_usuario = PerroPerdido.objects.filter(publicador = self.cliente, adoptado=False)
